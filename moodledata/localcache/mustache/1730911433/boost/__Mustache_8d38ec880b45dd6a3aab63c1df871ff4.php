...
class __Mustache_8d38ec880b45dd6a3aab63c1df871ff4 extends Mustache_Template
{
...
';
        $value = $context->find('caninstall');
        $buffer .= $this->section8b70cf4e4b0757b0b2d0558e3d3c2bde($context, $indent, $value);
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '</div>
';
...
';
    ...
    private function section8b70cf4e4b0757b0b2d0558e3d3c2bde(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
